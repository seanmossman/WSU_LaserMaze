...
class Application(tk.Frame):
    ...
    def bCalibrate(self):
        ...
        self.bCalibrate.grid(row = 2, column = 2, columnspan = 1 ,sticky="ew")
    def bStop(self):
        self.bStop = tk.Button(self, text="Stop", fg = "yellow", bg = "black")
        self.bStop["command"] = self.stop_maze
        self.bStop.grid(row=2, column = 3, columnspan = 1, sticky = "ew")
#========================================================================
    def quit_maze(self):
        global maze_running        
        ser.write(b'0')
